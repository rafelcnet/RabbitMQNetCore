...
namespace Identity.Api
{
    public class Startup
    {
            ...
            builder.Register(context =>
                {
                    var busControl = Bus.Factory.CreateUsingRabbitMq(cfg =>
                    {
                        ...
                        var host = cfg.Host("172.17.0.2", "/", h =>
                        {
                            h.Username("rcotest");
                            h.Password("Test2019");
                        });
                        ...
                        cfg.ReceiveEndpoint(host, "ApplicantsAndJobs" + Guid.NewGuid().ToString(), e =>
                        {
                            e.LoadFrom(context);
        ...
        public async void Configure(IApplicationBuilder app, IHostingEnvironment env, IServiceProvider serviceProvider, IApplicationLifetime lifetime)
        {
            ...
            await identityRepository.UpdateUserAsync(new User {Id = "1", Email = "rafaelc_70@hotmail.com",Name = "Rafa Cardenas"});
